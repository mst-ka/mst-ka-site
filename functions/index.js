...
exports.onDataAddedApps = functions.database
  ...
  .onCreate(function (snap, context) {
    ...
    text.message =
      ...
      text.email +
      "<br/><br/>" +
      `Address: ${text.address} ${text.city}, ${text.state} ${text.zip}` +
      "<br/><br/>" +
      "Age: " +
      text.age +
      "<br/><br/>" +
      ...
      text.goals +
      "<br/><br/>" +
      "Who have you been in contact with at KA?: " +
      text.contactWith +
      "<br/><br/>" +
      "Why are you considering KA?: " +
      text.whyConsidering +
      "<br/><br/>" +
      "What do you like about our Chapter?: " +
      text.likeAboutChapter +
      "<br/><br/>" +
