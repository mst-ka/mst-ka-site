...
function ParentsFAQ() {
  return (
    <Container sx={{ padding: { mobile: "2rem", laptop: "2rem 20rem" } }}>
      For your son, making the transition from high school or community college
      to a four-year college or university may seem like an imposing challenge.
      The Beta Alpha Chapter of Kappa Alpha Order knows you may be thinking
      about one or more of the following questions:
      <br />
      <br />
      <List
        dense
      ...
      on this new period in his life. Over 400,000 students across the country
      are currently fraternity members.
      <br />
      <br />
      The fraternity can help personalize your son&apos;s college experience by
      offering a scholastic support system, hands-on experience in leading
      ...
      educational programs and discussions with alumni, the chance to give back
      to the community through service projects, and close friends who will
      cheer him on when he is successful and support him when times are tough.
      With all these opportunities available to them, it is no wonder that
      fraternity members tend to graduate from college at a higher rate than
      those men not involved in fraternities.
      <br />
      <br />
      ...
      <br />
      <br />
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            irresponsible and abusive. In reality, fraternities are values-based
            organizations dedicated to the development of character and lifelong
            friendship.
            <br />
            <br />
            The following are some basic expectations of fraternal membership: I
            will strive for academic achievement and practice academic
            integrity; I will respect the dignity of all persons, therefore I
            will not physically, mentally, psychologically or sexually abuse or
            haze any human being; I will respect my property and the property of
            others, therefore, I will neither abuse nor tolerate the abuse of
            property; I will neither use nor support the use of illegal drugs; I
            will neither misuse nor support the misuse of alcohol; I acknowledge
            that a clean and attractive environment is essential to both
            physical and mental health, therefore, I will do all in my power to
            see that the chapter property is properly cleaned and maintained; I
            will challenge all my fraternity members to abide by these fraternal
      ...
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            laws, and university policies regarding the consumption of alcohol.
            In addition, most are not allowed to purchase alcohol for members.
            The days of large quantities of alcohol at a social function are
            gone. Instead, you will find fraternity members participating in
            alcohol-free social activities like moonlight bowling, dinner
            exchanges, ect. Students who choose not to drink will know that it
            is ok and feel comfortable with their decision.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            Students often find managing their time difficult when moving from a
            highly structured high school environment to the freedoms of
            ...
            study hours, and time management workshops. Your son can access the
            network of fraternity members who already know how to use campus
      ...
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            During this time your son and the other new members will participate
            in weekly meetings to learn about the university and fraternity,
            leadership retreats, community service projects, and activities
            designed to build friendships among new members and the older
            fraternity members.
            <br />
            <br />
      ...
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            college students are more likely to graduate and they report greater
            satisfaction with their college experience. Through his fraternity
            involvement your son will learn to balance his academic, work,
            campus involvement, and social commitments. member.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
      ...
      <Accordion sx={{ backgroundColor: "primary.main", color: "white.main" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            Fraternity members will be more than happy to educate him (and you)
