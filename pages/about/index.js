    ...
    <Container sx={{ padding: { mobile: "2rem", laptop: "2rem 20rem" } }}>
      <Grid container spacing={8}>
        <Grid item mobile={12} tablet={6}>
          ...
          <Typography>
            Kappa Alpha Order was founded by four men, bound their friendship in
            a “mutual pledge of faith and loyalty,” at Washington College in
            Virginia, in December of 1865.
            <br />
            <br />
            Our founders created an organization rooted in the highest ideals of
            the time: honor, chivalry, and gentility.
            <br />
            <br />
            KA translates these timeless philosophies into the mainstream of
            American universities. These gentlemanly traits are the hallmark of
            men who have chosen our unique lifestyle.
          </Typography>
        </Grid>
        <TextSectionImage
        ...
        <Grid item mobile={12} tablet={6}>
          ...
          <Typography>
            ...
            fraternity experience. Transitioning to college life, students often
            search for a group -- somewhere they feel comfortable working with
            ...
            <br />
            <br />
            The benefits of fraternal membership do not stop when you graduate.
            KA chapters are supported by Alumni who can ease the transition to
            post-graduate life. Our alums build networks during their
            professional careers -- contacts you will want to know.
            <br />
            <br />
            Fraternity membership does not guarantee a job following graduation,
            it does provide great resources that you would not have otherwise
            had.
          </Typography>
        </Grid>
        <TextSectionImage
        ...
        <Grid item mobile={12} tablet={6}>
          ...
          <Typography>
            ...
            developing your values and experiences, and pointing you in a great
            direction for your future. Based on our history and your experience,
            your journey in life becomes clearer.
          </Typography>
        </Grid>
        ...
        <Grid item mobile={12} tablet={6}>
          <TextSectionHeading>History of Beta Alpha Chapter</TextSectionHeading>
          <Typography>
            The Beta Alpha Chapter of Kappa Alpha Order was founded on April 27,
            1903, making it the second oldest fraternity on campus
            <br />
            <br />
            ...
            <br />
            <br />
            In 2014, the KA house received a total renovation which added space
            and converted additional areas for educational purposes.
            <br />
            <br />
