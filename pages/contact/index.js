...
function Contact() {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <Container sx={{ padding: { mobile: "2rem", laptop: "2rem 12rem" } }}>
        <Typography variant="h4" align="center">
          Apply For Membership
        </Typography>
        <br />
        <Typography align="center">
          At Kappa Alpha Order we are determined to recruit men who will become
          contributing members to our brotherhood. This application is meant to
          help us get to know you, and decide whether you have what it takes to
          become a member of Kappa Alpha. We ask that you fill this out honestly
          because properly picking members is just as important for you as it is
          for us.
        </Typography>
        <br />
        <Typography align="center">
          Also, every summer we host several Rush events in the St. Louis and
          Kansas City areas. These events are meant to help us get to know you,
          and for you to get to know us. It is not required for you to attend a
          Rush event, but it is highly recommended that you do so. All costs of
          the events are covered by KA and rides to and from the events can be
          arranged upon request. For more information, or to sign up for an
          event please contact either one of our{" "}
          <Link href="/about/ba-of-ka-officers">Recruitment Chairs</Link>.
        </Typography>
        <br />
      </Container>
          ...
          <Grid container direction="column" spacing={2}>
            ...
            <Grid item>
              <TextField
                ...
                helperText={
                  formik.touched.whyConsidering && formik.errors.whyConsidering
                }
              />
            </Grid>
            <Grid item>
            ...
            <Grid item>
              <TextField
                ...
                helperText={formik.touched.gentleman && formik.errors.gentleman}
              />
            </Grid>
            <Grid item>
